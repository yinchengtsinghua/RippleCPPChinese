...
//使用JTX建立一个分类账，这样测试就能做正确的事情。
test::jtx::Account const a {"a"}; //Rnuy2shtrb9dubspmkjzuxtf5fcndgryea公司
test::jtx::Account const g {"g"}; //rlpwb1itaugmv8kbmlysjgkeptm2大豆4
        auto const USD = g["USD"];

//账号：RJRXI4WXEv4BNAGVNP9YCDKPDAOKFAMCSI
//种子：sh1yjfwoil98zcygwijuzuhmjdevkd
        test::jtx::Account const ed {"ed", KeyType::ed25519};
//主人是rhb9cjawyb4rj91vrwn96dkukg4bwdyth。
//“B”（不在分类帐中）是RDG53HAIK2475DJX8BJMDSDPJ4VX7HTAMD。
//“c”（幻影签名者）是rpcnzota6b8ybokhytcntnqvcntbnwfux。
