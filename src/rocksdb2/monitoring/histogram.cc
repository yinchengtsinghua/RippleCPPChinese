...
(b == 0) ? 0 : bucketMapper.BucketLimit(b-1),  //左边
bucketMapper.BucketLimit(b),  //正确的
bucket_value,                   //计数
(mult * bucket_value),           //百分比
(mult * cumulative_sum));       //累计百分比
    r.append(buf);
