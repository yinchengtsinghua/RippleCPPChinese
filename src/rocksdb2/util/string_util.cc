...
//对于小于10毫秒的micros，请打印“xx us”。
//对于小于10秒的micros，打印“xx ms”。
//对于大于等于10秒的micros，打印“xx秒”。
//对于micros<=1小时，打印y:x m:s“。
//如果micros>1小时，请打印z:y:x h:m:s”。
...
//对于大于等于10TB的尺寸，请打印“XXTB”
//对于大于等于10GB的尺寸，请打印“XXGB”
//等。
//将文件大小摘要附加到输出并返回len
