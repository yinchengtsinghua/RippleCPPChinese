...
{
    return
((addr.to_ulong() & 0xff000000) == 0x0a000000) || //前缀/8，10.第二、第二章
((addr.to_ulong() & 0xfff00000) == 0xac100000) || //前缀/12 172.16.-172.31.
((addr.to_ulong() & 0xffff0000) == 0xc0a80000) || //前缀/16 192.168..
        addr.is_loopback();
}
