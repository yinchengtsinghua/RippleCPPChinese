...
//存储数据以便以后处理，并查看是否需要调度
    ...
    /*我们有一些账本的数据，自从我们付了钱以后，就再也没有了。
        收到它的价格，我们最好把它藏起来以备不时之需。

        节点以有线格式接收，必须以前缀形式存储/散列
        格式
    **/
